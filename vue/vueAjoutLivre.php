...
class vueAjoutLivre extends Vue {
	...
	include "header.html";
        ...
        echo "<form class='add_livre' method='post' action='index.php?action=validLivre&id=".$_SESSION['token']."required'>";
       ...
       echo '<input class="form-check-input" name="information" type="checkbox" value="" id="ok" >';
